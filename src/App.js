    ...
    <BrowserRouter>
      ...
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          <Route path='/presidentialresults' element={<PresidentialResult />} />
          <Route
            path='/gubernatorialresults'
            element={<GubernatorialResult />}
          />
          <Route path='/senatorialresults' element={<SenatorialResult />} />
          <Route path='/horresults' element={<HorResult />} />
          <Route path='/hoaresults' element={<HoaResult />} />
          <Route path='/results'>
            {/*  <Route index element={<PresidentialResult />} /> */}

            <Route path='presidential' element={<ResultPresidential />} />

            <Route path='senatorial' element={<ResultSenatorial />} />
            <Route path='gubernatorial' element={<ResultGovernors />} />
            <Route path='house_of_reps' element={<ResultReps />} />
            <Route path='house_of_assembly' element={<ResultAssembly />} />
          </Route>
          <Route path='/results/kwara/:lga' element={<LGA />} />
          {/* <Route
						path="/news"
						element={<News />}
					/> */}
