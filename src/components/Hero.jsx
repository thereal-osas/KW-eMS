        ...
        <div className='mb-32'>
          <div>
            ...
            <p className='text-center mt-6 text-sm'>
              A comprehensive and user-friendly platform to stay <br /> informed
              and updated about the electoral process
            </p>
          </div>
          <div
            id='hero'
            className='relative text-center mx-auto mt-24 md:mt-52 bg-[#dee7fd] w-3/4 md:w-6/12 h-44 md:h-72 rounded-lg flex'
          >
            <div id='stats' className='absolute bottom-2 left-4 md:left-10'>
