          ...
          >
            ...
            <div className='flex justify-around mt-4'>
              <div className='bg-[#fff] shadow-lg py-5 px-10 border-[#e3e3e3] rounded'>
                ...
                <div class='border-b-2 border-[#f3f3f3] w-56 mt-12'></div>
                <Checkbox
                ...
                <Checkbox
                  ...
                  onChange={handleCheckboxChange}
                />
                <Checkbox label='Peter Obi' onChange={handleCheckboxChange} />
              </div>
              <div className='bg-[#fff] shadow-lg py-5 px-10 border-[#e3e3e3]  rounded'>
                <div className='py-2 px-3 bg-[#c8d6f9] rounded-lg'>
                  Select Election
                ...
                <Checkbox
                  ...
                  onChange={handleCheckboxChange}
                />
                <Checkbox label='Senatorial' onChange={handleCheckboxChange} />
                <Checkbox
